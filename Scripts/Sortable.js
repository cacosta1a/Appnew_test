		...
		constructor: Sortable,
 		...
 		_dragStarted: function () {
			if (rootEl && dragEl) {
				...
				gl_elemento_arrastrado=this.elemento_padre;
			}
		},
			...
			if (type === 'dragover' || type === 'dragenter') {
			  ...
			  //  evt.stopPropagation();
			    ...
			    if (type == "dragend");
			    {
			          ...
			          fin_cambio_drag_drop(gl_elemento_arrastrado);
			          
			         // alert(target.offsetParent.id);
			    }
