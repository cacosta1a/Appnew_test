...
jQuery.fn.motionCaptcha || (function($) {
	...
	$.fn.motionCaptcha.defaults = {
		...
		errorMsg: 'Porfavor, pruebe de nuevo.',
		successMsg: 'Reconocimiento aprobado!',
		...
		onSuccess: function($form, $canvas, ctx) {
			var opts = this,
				$submit = opts.submitId ? $form.find(opts.submitId) : $form.find('input[type=submit]');
